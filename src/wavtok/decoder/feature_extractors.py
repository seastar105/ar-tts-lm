...
from src.wavtok.decoder.modules import safe_log
from src.wavtok.encoder import EncodecModel
from src.wavtok.encoder.modules import SEANetDecoder, SEANetEncoder
from src.wavtok.encoder.quantization import ResidualVectorQuantizer
...
class EncodecFeatures(FeatureExtractor):
    def __init__(
        ...
        quantizer = ResidualVectorQuantizer(
            dimension=512, n_q=n_q, bins=vq_bins, kmeans_iters=vq_kmeans, decay=0.99, kmeans_init=True
        )
        ...
        if encodec_model == "encodec_24khz":
            ...
            raise ValueError(f"Unsupported encodec_model: {encodec_model}. Supported options are 'encodec_24khz'.")
