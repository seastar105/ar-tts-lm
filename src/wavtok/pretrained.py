...
from src.wavtok.decoder.feature_extractors import EncodecFeatures, FeatureExtractor
from src.wavtok.decoder.heads import FourierHead
from src.wavtok.decoder.models import Backbone
...
class WavTokenizer(nn.Module):
    ...
    @classmethod
    def from_hparams0802(cls, config_path: str):
        """
        Class method to create a new Vocos model instance from hyperparameters stored in a yaml configuration file.
        """
        with open(config_path) as f:
